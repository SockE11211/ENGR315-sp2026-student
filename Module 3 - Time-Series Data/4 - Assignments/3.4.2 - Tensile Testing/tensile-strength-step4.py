...
def calculate_max_strength_strain(strain, stress):
    ...
    for data in stress:
        if data > ultimate_tensile_stress:
            ultimate_tensile_stress = data

    # calculate the maximum strain experienced
    fracture_strain = -1
    for data in strain:
        if data > fracture_strain:
            fracture_strain = data
